package pgg.com.signinteacherapp.data.retrofit;
...
public class OkHttp3Utils {
    ...
    //设置缓存目录 100M
    private static File file=new File(MyApplication.getInstance().getApplicationContext().getExternalCacheDir(),"MyCache");
